...
export function HelpModal({ open, onClose, excludeAnswer }: HelpModalProps) {
  ...
  return (
    <Modal open={open} onClose={onClose} title="How to play" maxWidth="max-w-[640px]" variant="result">
      <h3 className="text-[1.6rem] leading-tight font-extrabold tracking-[-0.01em]">
        Guess the country in 6 tries.
      </h3>
      <ul className="mt-2 list-disc space-y-1.5 pl-5 text-[0.95rem] leading-snug">
      ...
      <h4 className="mt-5 text-[0.95rem] font-bold">Examples</h4>
